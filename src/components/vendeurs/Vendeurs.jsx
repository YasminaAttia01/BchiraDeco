  ...
  const boxes = [
    {
      ...
      title: "Réception des photos",
      text: "Envoyez les photos de vos vêtements à notre page Facebook ou à notre adresse e-mail.",
    ...
    },
    {
      ...
      text: "Suivez les interactions avec les clients et répondez à leurs questions.",
    ...
    },
    {
      ...
      text: "Intégrez les articles sur notre site web en utilisant les photos et les descriptions que nous avons préparées.",
      background: "rgba(255, 243, 183, 1)",
    },
    {
      icon: (
      ...
      text: "Une fois l'article vendu, nous vous verserons votre montant.",
      background: " rgba(221, 227, 219, 1)",
    },
  ];
  return (
